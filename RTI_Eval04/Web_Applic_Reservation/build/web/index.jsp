        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <hr class="my-4" />
                    <h2 class="text-white-50 mx-auto mt-2 ">Bienvenue sur l'application de réservation d'InpresPFM !</h2>
				...
				<form class="contact3-form validate-form" method="post" action=CheckLogin>
					...
					<div class="wrap-contact3-form-radio">
						<div class="contact3-form-radio m-r-42">
							<input class="input-radio3" id="radio1" type="radio" name="choice" value="connection" checked="checked">
						...
						<div class="contact3-form-radio">
							<input class="input-radio3" id="radio2" type="radio" name="choice" value="inscription">
					...
					<div class="wrap-input3 validate-input" data-validate="Name is required">
						<input class="input3" type="text" name="name" placeholder="Votre login">
						<span class="focus-input3"></span>
					</div>

					<div class="wrap-input3 validate-input" data-validate = "Password is required">
						<input class="input3" type="password" name="pass" placeholder="Votre mot de passe">
						<span class="focus-input3"></span>
					</div>
                                        <!--
