 ...
 * @author isen0
 */
public class FenAppServeurIOBREP extends javax.swing.JFrame implements ConsoleServeur {

    /**
     * Creates new form FenAppServeurIOBREP
     */
    private int port;
    public FenAppServeurIOBREP() {
        initComponents();
        setLocation(300, 300);  
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Serveur Bateaux");
    ...
    private void jButtonServeurStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonServeurStartActionPerformed
        ...
        ThreadServeurBateaux ts = new ThreadServeurBateaux(port, new ListeTaches(), this);
        ts.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenAppServeurIOBREP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FenAppServeurIOBREP().setVisible(true);
            }
        });
    }
